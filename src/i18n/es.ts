export const es = {
  ...
  about: {
    chip: "Abierta a oportunidades · Madrid",
    cvPath: "/curriculum_es.pdf",
    cvFilename: "CV_Pilar_Santos_ES.pdf",
    downloadCv: "Descargar CV",
    description:
      "Soy una Desarrolladora de Software Junior con experiencia en tecnologías como Java, JavaFX, Spring Boot y React, desarrollando tanto aplicaciones de escritorio como proyectos web. Disfruto aprendiendo de los equipos con los que trabajo y afrontando retos que me ayuden a crecer. Busco una empresa donde pueda aportar desde el primer día y seguir creciendo como desarrolladora de software.",
  },
  experience: {
    title:{
    ...
    burofreeAiInternship: {
      title: "Burofree AI",
      role: "Prácticas · Desarrolladora de Software",
      description:
  ...
  contact: {
    title: "Contacto",
    subtitle: "¿Tienes alguna pregunta o quieres trabajar juntos? Escríbeme.",
    name: "Nombre",
    email: "Email",
    message: "Mensaje",
    send: "Enviar",
    ...
    error: "Algo salió mal, inténtalo de nuevo o contactame directamente utilizando el botón mail en la página principal.",
  },
} as const;
